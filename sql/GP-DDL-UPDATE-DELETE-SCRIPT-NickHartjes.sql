...
-- Als een spel geupdate word, moet ook het artikel worden geupdate. Maar niet verwijderd
...
-- Als het spel geupdate word, moet ook de categorie per spel koppeltabel aangepast worden
