...
WHILE (1 = 1)
  BEGIN
    ...
    SET EMAILADRES = (
      ...
      WHERE AV.BARCODE = @barcode AND AV.STARTDATUM = @startdatum
    )
...
/*==============================================================*/
ALTER TABLE REPARATIE
  ALTER COLUMN EMAILADRES VARCHAR(100) NOT NULL ;
GO

ALTER TABLE REPARATIE
  ADD CONSTRAINT PK_REPARATIE PRIMARY KEY (BARCODE, STARTDATUM, EMAILADRES)
GO
