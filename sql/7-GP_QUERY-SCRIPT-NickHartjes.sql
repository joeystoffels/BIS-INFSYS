...
-- NB: "HO.EINDDATUM >= '2017-06-01'" moet eigenlijk "HO.EINDDATUM >= GETDATE()" zijn, maar dit levert op de huidige dataset geen
-- gegevens op, vandaar dat een fictieve 'huidige' datum gebruikt is van 1 juni 2016.
SELECT K.EMAILADRES
    , K.VOORNAMEN
    , K.ACHTERNAAM 
    , A.MERK
...
WHERE A.SPEL_OF_CONSOLE = 'CONSOLE' AND HO.STARTDATUM <= GETDATE() AND HO.EINDDATUM >= '2017-06-01' AND HO.HUURSTATUS = 'VERHUURD';
